...
const NAV = [
  ...
  { href: "/proyecciones", label: "Proyecciones", icon: LineChart, permiso: "verProyecciones" as const },
  { href: "/metas", label: "Metas Económicas", icon: Target, permiso: "verMetas" as const },
